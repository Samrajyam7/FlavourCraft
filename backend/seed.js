...
const buildRecipes = (ingMap) => [
  ...
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Pressure cook soaked black lentils with garlic and salt until completely soft and mashable.', timerMinutes: 20 },
      { step: 2, description: 'In a pot, melt butter and cook tomato puree with ginger and chilli for 10 minutes.', timerMinutes: 10 },
      { step: 3, description: 'Add cooked lentils and mash a portion with the back of a ladle.', timerMinutes: 3 },
      { step: 4, description: 'Simmer on low flame for 30 minutes, stirring occasionally as it turns velvety.', timerMinutes: 30 },
      { step: 5, description: 'Finish with garam masala, kasuri methi, and an extra pat of butter.', timerMinutes: 2 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Blanch fresh spinach in boiling water for 2 minutes, then plunge into ice water to keep bright green. Puree smooth.', timerMinutes: 2 },
      { step: 2, description: 'Heat ghee in a pan, add cumin seeds until they sizzle.', timerMinutes: 1 },
      { step: 3, description: 'Add garlic, ginger, and onion. Sauté until translucent.', timerMinutes: 4 },
      { step: 4, description: 'Pour in spinach puree, garam masala, and salt. Simmer 5 minutes.', timerMinutes: 5 },
      { step: 5, description: 'Gently fold in fresh paneer cubes and warm through for 2 minutes before serving.', timerMinutes: 2 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Heat oil in a pan, add cumin seeds and allow them to crackle.', timerMinutes: 1 },
      { step: 2, description: 'Add onion paste and sauté until golden brown and aromatic.', timerMinutes: 6 },
      { step: 3, description: 'Add ginger-garlic paste and tomato puree. Cook for 8 minutes until oil separates.', timerMinutes: 8 },
      { step: 4, description: 'Add boiled chickpeas, garam masala, salt, and 1 cup water. Lightly mash some chickpeas.', timerMinutes: 3 },
      { step: 5, description: 'Simmer for 15 minutes. Garnish with fresh ginger slivers and chopped coriander.', timerMinutes: 15 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Heat oil in a kadai / pan, add cumin seeds and green chillies.', timerMinutes: 1 },
      { step: 2, description: 'Add diced potatoes and cauliflower florets. Stir-fry on medium heat for 5 minutes.', timerMinutes: 5 },
      { step: 3, description: 'Add turmeric, ginger, salt, and green peas. Toss well to coat.', timerMinutes: 2 },
      { step: 4, description: 'Cover with lid and cook on low heat for 12-15 minutes until veggies are tender.', timerMinutes: 15 },
      { step: 5, description: 'Uncover, sprinkle chopped coriander, and serve with hot chapatis.', timerMinutes: 1 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Boil toor dal with turmeric and tomatoes until soft and mashable.', timerMinutes: 15 },
      { step: 2, description: 'Cook carrots and onions in tamarind water with salt until tender.', timerMinutes: 10 },
      { step: 3, description: 'Mix the mashed dal into the tamarind vegetable broth and simmer 10 mins.', timerMinutes: 10 },
      { step: 4, description: 'Tadka: Heat ghee in a small pan, add mustard seeds and curry leaves until they crackle.', timerMinutes: 2 },
      { step: 5, description: 'Pour aromatic tadka over the bubbling sambar and stir well.', timerMinutes: 1 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Prick boiled eggs with a fork and fry with a pinch of turmeric and chilli until blistered and golden.', timerMinutes: 3 },
      { step: 2, description: 'In the same pan, fry onions until deep brown.', timerMinutes: 6 },
      { step: 3, description: 'Add ginger-garlic paste, chillies, and tomatoes. Sauté until mushy and oil releases.', timerMinutes: 5 },
      { step: 4, description: 'Add garam masala, ½ cup water, and simmer into a thick gravy.', timerMinutes: 5 },
      { step: 5, description: 'Drop the fried eggs in and simmer for 5 minutes. Serve with hot roti or rice.', timerMinutes: 5 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Rub fish fillets with turmeric and salt. Let rest for 10 minutes.', timerMinutes: 10 },
      { step: 2, description: 'Heat oil in a pan, add mustard seeds, curry leaves, ginger, and green chillies.', timerMinutes: 2 },
      { step: 3, description: 'Pour in coconut milk and ½ cup water. Bring to a gentle simmer.', timerMinutes: 4 },
      { step: 4, description: 'Slide fish fillets into the coconut gravy. Simmer on low heat for 7-8 minutes.', timerMinutes: 8 },
      { step: 5, description: 'Serve hot with steamed basmati rice.', timerMinutes: 1 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Heat ghee in a pan, temper with cumin seeds.', timerMinutes: 1 },
      { step: 2, description: 'Add onions, garlic, and ginger. Sauté until dark brown.', timerMinutes: 8 },
      { step: 3, description: 'Add tomato puree and spices. Cook until oil leaves the sides.', timerMinutes: 7 },
      { step: 4, description: 'Add boiled kidney beans and bean broth. Lightly mash some beans for thick gravy.', timerMinutes: 3 },
      { step: 5, description: 'Simmer on low for 20 minutes. Garnish with coriander and serve with steamed rice.', timerMinutes: 20 },
    ],
  },
  {
    ...
    instructions: [
      { step: 1, description: 'Cook dal with turmeric, salt, and water until soft and creamy.', timerMinutes: 15 },
      { step: 2, description: 'In a pot, heat 1 tbsp ghee, fry 1 tsp cumin seeds, add basmati rice and 3 cups water. Cook covered until fluffy.', timerMinutes: 15 },
      { step: 3, description: 'For Dal Tadka: Heat 1 tbsp ghee in a ladle, fry sliced garlic and 1 tsp cumin seeds until golden brown.', timerMinutes: 3 },
      { step: 4, description: 'Pour the sizzling garlic tadka over the dal and cover immediately to trap the smoky aroma.', timerMinutes: 1 },
      { step: 5, description: 'Serve piping hot dal over fragrant jeera rice.', timerMinutes: 1 },
    ],
  },
];
